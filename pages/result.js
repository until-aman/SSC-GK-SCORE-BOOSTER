      ...
      <div style={{ maxWidth: 430, margin: '0 auto', padding: '24px 16px 0', display: 'flex', flexDirection: 'column', gap: 14 }}>
        ...
        {feedbackSent ? (
          ...
          <AppCard
            ...
            className="w-full"
            style={{ display: 'flex', alignItems: 'center', gap: 12, boxSizing: 'border-box', background: 'rgba(30,41,59,0.72)', border: '1px solid rgba(148,163,184,0.14)', borderLeft: '4px solid rgba(255,122,26,0.7)', cursor: 'pointer', textAlign: 'left', fontFamily: 'inherit' }}
          >
        ...
        {/* ── 7. SHARE RESULT ── */}
        <AppCard style={{ background: '#172235', border: '1px solid #2A3A52', borderLeft: '4px solid #34D399' }}>
          <SectionHeader
