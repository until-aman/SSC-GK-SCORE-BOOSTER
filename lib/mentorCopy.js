...
export const MENTOR_COPY = {
  ...
  // Task type messages
  THEORY_GUIDANCE: "Is topic ki theory abhi cover nahi hui hai. Pehle apne source se padh lijiye, phir confirm karein.",
  PRACTICE_GUIDANCE: "Is topic ki theory complete ho chuki hai. Ab questions practice karne se aapka confidence strong hoga.",
  MISTAKE_RECOVERY_GUIDANCE: "Aapne yeh questions pehle galat kiye hain. Ek baar revise kar lijiye - score recover hoga.",
  REVISION_GUIDANCE: "Is topic mein mistakes zyada aa rahi hain. Pehle quick revision kar lijiye, phir dobara attempt karein.",
  DAILY_PRACTICE_GUIDANCE: "Aaj ka Daily Challenge attempt kar lijiye. Yeh routine practice ka important part hai.",
  SAVED_QUESTION_GUIDANCE: "Aapne yeh questions save kiye hain. Aaj inhe revise kar lijiye.",
