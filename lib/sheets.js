...
/**
 * Append a V2 score row (15 columns) to the Scores sheet.
 * Col N (index 13) = streakMilestoneBonus
 * Col O (index 14) = totalXP (cumulative XP after this submission)
 */
  ...
  await sheets.spreadsheets.values.append({
    ...
    requestBody: {
      values: [[
        ...
        subject, topic, sessionId, xpEarned, isDailyChallenge, streakMilestoneBonus, totalXP,
      ]],
    },
  });
}
